...
def get_dataset_loader(datasetRootDir, cnt_to_load=None):
    DATASET_ROOT_DIR = datasetRootDir

    if cnt_to_load != None:
        NUM_IMAGES = cnt_to_load
    else:
        NUM_IMAGES = len(os.listdir(f'{DATASET_ROOT_DIR}/annos'))
    ...
    for num in tqdm(range(1, NUM_IMAGES)):
        json_name = f'{DATASET_ROOT_DIR}/annos/' + str(num).zfill(6)+'.json'
        image_name = f'{DATASET_ROOT_DIR}/image/' + str(num).zfill(6)+'.jpg'
